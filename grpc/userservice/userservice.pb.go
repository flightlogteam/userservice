...
type FlyingDeviceExsistsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *FlyingDeviceExsistsRequest) Reset() {
	*x = FlyingDeviceExsistsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *FlyingDeviceExsistsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FlyingDeviceExsistsRequest) ProtoMessage() {}

func (x *FlyingDeviceExsistsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_userservice_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FlyingDeviceExsistsRequest.ProtoReflect.Descriptor instead.
func (*FlyingDeviceExsistsRequest) Descriptor() ([]byte, []int) {
	return file_userservice_proto_rawDescGZIP(), []int{8}
}

func (x *FlyingDeviceExsistsRequest) GetDeviceId() string {
	if x != nil {
		return x.DeviceId
	}
	return ""
...
type FlyingDeviceExsistsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Exsists bool `protobuf:"varint,1,opt,name=exsists,proto3" json:"exsists,omitempty"`
}

func (x *FlyingDeviceExsistsResponse) Reset() {
	*x = FlyingDeviceExsistsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *FlyingDeviceExsistsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FlyingDeviceExsistsResponse) ProtoMessage() {}

func (x *FlyingDeviceExsistsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_userservice_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FlyingDeviceExsistsResponse.ProtoReflect.Descriptor instead.
func (*FlyingDeviceExsistsResponse) Descriptor() ([]byte, []int) {
	return file_userservice_proto_rawDescGZIP(), []int{9}
}

func (x *FlyingDeviceExsistsResponse) GetExsists() bool {
	if x != nil {
		return x.Exsists
	}
	return false
...
var file_userservice_proto_rawDesc = []byte{
	...
	0x44, 0x41, 0x54, 0x41, 0x10, 0x03, 0x22, 0x38, 0x0a, 0x1a, 0x46, 0x6c, 0x79, 0x69, 0x6e, 0x67,
	0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x45, 0x78, 0x73, 0x69, 0x73, 0x74, 0x73, 0x52, 0x65, 0x71,
	...
	,
	...
	,
...
var file_userservice_proto_goTypes = []interface{}{
	...
	(*FlyingDeviceExsistsRequest)(nil),     // 12: usergrpc.FlyingDeviceExsistsRequest
	(*FlyingDeviceExsistsResponse)(nil),    // 13: usergrpc.FlyingDeviceExsistsResponse
}
var file_userservice_proto_depIdxs = []int32{
	...
	12, // 8: usergrpc.UserService.FlyingDeviceExsists:input_type -> usergrpc.FlyingDeviceExsistsRequest
	7,  // 9: usergrpc.UserService.ActivateUser:output_type -> usergrpc.ActivateUserResponse
	9,  // 10: usergrpc.UserService.LoginUser:output_type -> usergrpc.LoginResponse
	11, // 11: usergrpc.UserService.RegisterUser:output_type -> usergrpc.CreateUserResponse
	6,  // 12: usergrpc.UserService.UserByUserId:output_type -> usergrpc.UserByIdResponse
	13, // 13: usergrpc.UserService.FlyingDeviceExsists:output_type -> usergrpc.FlyingDeviceExsistsResponse
...
func file_userservice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_userservice_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FlyingDeviceExsistsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_userservice_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FlyingDeviceExsistsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
